...
<div class="content"> <!-- Inicio da DIV content -->
    <div class="bt_link_new">
        <a href="<?php echo base_url() ?>ambulatorio/empresa/configurarinternacao/0">
            Novo Modelo
        </a>
    </div>
    <div id="accordion">
                        ...
                        foreach ($lista as $item) {
                            ...
                            <tr>
                                ...
                                <td style="width: 120px;"  class="<?php echo $estilo_linha; ?>"><div class="bt_link">
                                        <a href="<?= base_url() ?>ambulatorio/empresa/configurarinternacao/<?= $item->empresa_impressao_internacao_id; ?>">Editar</a></div>
                                </td>
                                <?php if($this->session->userdata('perfil_id') != 25 && $perfil_id != 18 && $perfil_id != 20){?>

                                <td style="width: 120px;" class="<?php echo $estilo_linha; ?>"><div class="bt_link">
                                        <a onclick="javascript: return confirm('Deseja realmente excluir o modelo de impressão?');" href="<?= base_url() ?>ambulatorio/empresa/excluirconfiguracaointernacao/<?= $item->empresa_impressao_internacao_id; ?>">Excluir</a></div>
                                </td>
                                <?php }?>
                                <?
                                $perfil_id = $this->session->userdata('perfil_id');
