<html>
    ...
    <body>
            ...
            <table id="tabelaspec" width="100%" border="1" align="center" cellpadding="0" cellspacing="0" class="tipp">
                <tbody>
                    <tr >
                        <td  width="133" height="51" style="font-size: 8px;"><p class="ttr"><strong style="font-weight: normal; text-align: center;"><strong style="font-weight: normal; text-align: left;"><img src="<?= base_url(). $relatorio[0]->caminho_logo ?>"  width="133" height="49" class="ttr"/></strong></strong></p></td>
                        <td bgcolor="#B1B1B1" height="51" colspan="8" class="ttrl" style="font-size: 8px;"><p>GUIA DE SERVIÇO PROFISSIONAL/SERVIÇO AUXILIAR DE
                            </p>
                    ...
                    <tr>
                        <td height="12" colspan="3" class="tc"><strong></strong></td>
            ...
            <table id="tabelaspec" width="100%" border="1" align="center" cellpadding="0" cellspacing="0" class="tipp">
                <tbody>
                    ...
                    <tr>
                        <td class="tic"><strong>E - Eletivo</strong></td>
                ...
                <tbody>
                    ...
                    <? for ($i=0; $i < 5; $i++) { ?>
                        ...
                        <tr>
                            ...
                            <td height="12" class="semborda"><strong></strong></td>
            ...
            <table id="tabelaspec" width="100%" border="1" align="center" cellpadding="0" cellspacing="0" class="tipp">
                <tbody>
                    ...
                    <tr class="semborda">
                        <td width="4%" height="12" class="semborda">36- Data</td>
                        <td width="6%" class="semborda">37- Hora Inicial</td>

                        <td width="7%" colspan="1" class="semborda">38- Hora Final</td>
