...
//                                                endif;
                                ...
                                <select name="medico" id="medico" class="size1">                                  
                                    <? foreach ($medicos as $value) : ?>
                                        <?php if ($value->operador_id == $this->session->userdata('operador_id')) { ?>
                                            <option value="<?= $value->operador_id; ?>" > <?php echo $value->nome . ' - CRM: ' . $value->conselho; ?>
                                            </option>
                                        <?php } ?>
                                    <? endforeach; ?>
                                </select>
                        ...
                        <th class="tabela_title">
                            <select name="situacao" id="situacao" class="size1">
                                <option value=""></option>
                                <option value="BLOQUEADO" <? if (@$_GET['situacao'] == "BLOQUEADO") {
                                            echo 'selected';
                                        } ?>>BLOQUEADO</option>
                                <option value="FALTOU" <? if (@$_GET['situacao'] == "FALTOU") {
                                            echo 'selected';
                                        } ?>>FALTOU</option>
                                <option value="OK" <? if (@$_GET['situacao'] == "OK") {
                                            echo 'selected';
                                        } ?>>OCUPADO</option>
                                <option value="LIVRE" <? if (@$_GET['situacao'] == "LIVRE") {
                                            echo 'selected';
                                        } ?>>VAGO</option>
                            </select>
                        </th>
