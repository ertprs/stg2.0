...
<body bgcolor="#C0C0C0">
    <div class="content"> <!-- Inicio da DIV content -->
        ...
        <div>
            <form name="form_faturar" id="form_faturar" action="<?= base_url() ?>ambulatorio/guia/gravarfaturadoprocedimentosfiladecaixa" method="post">
                <fieldset>
                    <table>
                        <tr>
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                <!--<input type="checkbox" name="saladeespera" id="saladeespera">--> 
                            </td>
                        </tr>
                    ...
                    Enviar da Sala de Espera <input type="checkbox" name="saladeespera" id="saladeespera"> 
                    <hr/>
                    <? if ($exame[0]->total > 0) { ?>
