<html>
    <head>
    <?
    $css = base_url() . "css/tabelarae.css";
    $cssArray = explode('/', $css);
    $css = str_replace($cssArray[2], 'localhost', $css);
    // var_dump($css); die;
    ?>
        <meta charset="utf-8">
    ...
    <body>
        <? if (count($relatorioTot) > 0) { ?>  
            <?
            foreach ($relatorioTot as $key => $value) {
                $relatorio = $value;
                if($key > 0){
                    echo '<pagebreak>';
                }
            ?>
            <table id="tabelaspec" width="100%" border="1" align="center" cellpadding="0" cellspacing="0" class="tipp">
                <tbody>
                    <tr >
                        <td  width="133" height="35" style="font-size: 8px;"><p class="ttr"><strong style="font-weight: normal; text-align: center;"><strong style="font-weight: normal; text-align: left;"><img src="<?= base_url(). $relatorio[0]->caminho_logo ?>"  width="133" height="35" class="ttr"/></strong></strong></p></td>
                        <td bgcolor="#B1B1B1" height="35" colspan="8" class="ttrl" style="font-size: 8px;"><p>GUIA DE SERVIÇO PROFISSIONAL/SERVIÇO AUXILIAR DE
                            </p>
                            <p> DIAGNÓSTICO E TERAPIA - SP/SADT</p></td>
                        <td bgcolor="#B1B1B1" width="239" style="font-size: 8px;"><p>2-N° Guia no Prestador</p><p><strong><?//= $relatorio[0]->guia_id ?></strong></p></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td height="12" colspan="2" class="tc"><strong><?= $relatorio[0]->registroans ?></strong></td>
                    ...
                    <tr>
                        <td height="12" colspan="3" class="tc"><strong><? $ano = substr($relatorio[0]->data_cadastro, 0, 4); ?>
                    ...
                    <tr>
                        <td colspan="10" align="center" bgcolor="#B1B1B1" style="text-align:left;font-size: 8px;"><strong > DADOS DO BENEFICIÁRIO</strong></td>
                    </tr>
                ...
                <tbody>
                    ...
                    <tr>
                        <td height="12" colspan="3" class="tc"><strong><? echo $relatorio[0]->convenionumero; ?></strong></td>
                    ...
                    <tr>
                        <td colspan="10" align="center" bgcolor="#B1B1B1" style="text-align:left;font-size: 8px;"><strong > DADOS DO SOLICITANTE</strong></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td height="12" colspan="2" class="tc"><strong><? echo $relatorio[0]->codigoidentificador; ?></strong></td>
            ...
            <table id="tabelaspec" width="100%" border="1" align="center" cellpadding="0" cellspacing="0" class="tipp">
                <tbody>
                    ...
                    <tr>
                        <td class="tc" style="height:10px;"><strong><?= $relatorio[0]->solicitante; ?></strong></td>
                        <td height="12" colspan="1" class="tc"><strong>&nbsp;</strong></td>
                    ...
                    <tr>
                        <td colspan="10" align="center" bgcolor="#B1B1B1" style="text-align:left;font-size: 8px;"><strong > DADOS DA SOLICITAÇÃO/ PROCEDIMENTOS E EXAMES SOLICITADOS</strong></td>
                    </tr>
                    <tr class="tic">
                    ...
                    <tr>
                        <td class="tic"><strong>
                            <?if($relatorio[0]->eletivo == 't'){
                                echo 'E - Eletivo';
                            }else if($relatorio[0]->emergencia == 't'){
                                echo 'E - Emergência';
                            }else{
                        ...
                        <td height="12" colspan="2" class="tic"><strong></strong><strong> </strong></td>
                ...
                <!--<a onmouseover="style = 'color:red;cursor: pointer;'" onmouseout="style = 'color:white;'"style="" onclick="javascript:window.open('<?= base_url() ?>ambulatorio/guia/impressaoguiaconsultaspsadt/<?= $test->ambulatorio_guia_id; ?>');">-->
                    ...
                    <? foreach ($relatorio as $value) { ?>
                        ...
                        <tr>
                            ...
                            <td height="12" class="semborda"><strong><? echo $value->codigo_procedimento; ?></strong></td>
            ...
            <table id="tabelaspec" width="100%" border="1" align="center" cellpadding="0" cellspacing="0" class="tipp">
                <tbody>
                    ...
                    <tr>
                        <td colspan="8" align="center" bgcolor="#B1B1B1" class="tic" style="text-align:left;font-size: 8px;"><strong > DADOS DO CONTRATADO EXECUTANTE</strong></td>
                    </tr>
                    <tr class="ti">
                    ...
                    <tr>
                        ...
                        <td height="12" class="tc"><strong><? echo $empresa[0]->razao_social; ?> </strong></td>

                        <td colspan="2" class="tc"><strong><?= $empresa[0]->cnes; ?> </strong><strong> </strong></td>
                    </tr>
                    <tr>
                        <td colspan="8" align="center" bgcolor="#B1B1B1" class="tic" style="text-align:left;font-size: 8px;"><strong > DADOS DO ATENDIMENTO</strong></td>
                    </tr>
                    <tr class="ti">
                    ...
                    <tr>
                        <td class="tc"><strong>05</strong></td>
                        <td height="12" class="tc"><strong>09</strong></td>

                        <td class="tc"><strong></strong></td>
                        <td colspan="1" class="tc"><strong> </strong></td>
                    </tr>
                    <tr>
                        <td colspan="8" align="center" bgcolor="#B1B1B1" class="tic" style="text-align:left;font-size: 8px;"><strong>DADOS DA EXECUÇÃO/PROCEDIMENTOS E EXAMES REALIZADOS</strong></td>
                    </tr>
                ...
                <tbody>
                    ...
                    <? foreach ($relatorio as $value) { ?>
                        ...
                        <tr>
                            ...
                            <td height="12" class="semborda"><strong><?// echo $value->inicio ?></strong></td>
                    ...
                    <tr>
                        <td colspan="12" align="center" bgcolor="#B1B1B1" class="tic" style="text-align:left;font-size: 8px;"><strong>IDENTIFICAÇÃO DO(s) PROFISSIONAL(is) EXECUTANTE(s)</strong></td>
                    </tr>
            ...
            <table id="tabelaspec" width="100%" border="1" align="center" cellpadding="0" cellspacing="0" class="tipp">
                <tbody>
                    ...
                    <?// foreach ($relatorio as $value) { ?>
                        <tr>
                            <td height="12" class="semborda"><strong></strong><strong></strong></td>
                    ...
                    <tr>
                        <td height="12" colspan="8" class="semborda"><strong>1- ___/___/_______&nbsp;&nbsp; _______________________________ 3- ___/___/_______&nbsp;&nbsp; _______________________________ 5- ___/___/_______&nbsp;&nbsp; _______________________________ 7- ___/___/_______&nbsp;&nbsp; _______________________________ 9- ___/___/_______&nbsp;&nbsp; _______________________________</strong></td>
                    </tr>
                    <tr>
                        <td height="12" colspan="8" class="semborda"><strong>2- ___/___/_______&nbsp;&nbsp; _______________________________ 4- ___/___/_______&nbsp;&nbsp; _______________________________ 6- ___/___/_______&nbsp;&nbsp; _______________________________ 8- ___/___/_______&nbsp;&nbsp; _______________________________ 10- ___/___/_______&nbsp;&nbsp; _______________________________</strong></td>
                    </tr>
