...
<br><br><br>
    ...
    <div >
        <form name="form_laudo" id="form_laudo" enctype="multipart/form-data" action="<?= base_url() ?>ambulatorio/laudo/gravaranaminese/<?= $ambulatorio_laudo_id ?>/<?= $exame_id ?>/<?= $paciente_id ?>/<?= $procedimento_tuss_id ?>/TRUE" method="POST">
            <div >
                                        ...
                                        <table >
                                            ...
                                            <td rowspan="11" >
                                                ...
                                                <div id="anamnesePadrao">
                                                    <textarea id="laudo" name="laudo" rows="30" class="tinymce" id="tinymce" cols="80" style="width: 800px"><?=@$obj->_adendo; ?></textarea>
                                                </div>
                                               <? //print_r($obj->_adendo);?>
                                            </td>
                                                ...
                                                <div class="area-upload2">                                                       
                                                      <div class="lista-uploads">
                                                            ...
                                                            <div id="myModal" class="modal" hidden>
                                                                        ...
                                                                        <br><br>
                                                                            <input type="text" name="renomear_arquivo" class="texto10"/>
                                                                            <input type="text" readonly name="extensao_arquivo" class="texto01" value="<?@$teste;?>"/>
                                                                        <br><br>
                                                                        </div>
                                                                        <div class="modal-footer">
                                                                            <h3><button type="button" name="renomear"> Renomear </button></h3>
                                                                        </div>
                                                                        </div> -->
                                                ...
                                                <div>
                                                    ...
                                                    foreach ($historico as $item) {
                                                        ...
                                                        <table>
                                                            <tbody>
                                                                <tr>
                                                                    <td ><b>Data:</b> <?= substr($item->data_cadastro, 8, 2) . "/" . substr($item->data_cadastro, 5, 2) . "/" . substr($item->data_cadastro, 0, 4); ?></td>
                                                                <?
                                                                $idade = 0;
                                                                ...
                                                                <tr>
                                                                    <td colspan="3"><b>Medico: </b><?= $item->medico; ?></td>
                                                                </tr>
                                   ...
                                   $(function () {
                                    ...
                                    function pre_apresentacao(link) {
                                                                            ...
                                                                            $("#apresentacao_tabela").append(
                                                                                "<tr id='removepreapresentacao'>"+
                                                                                    "<td colspan='3'>"+
                                                                                    "<iframe src='"+link+"' width='450' height='430' style='border: none;'></iframe>"+
                                                                                    "</td>"+
                                                                                "</tr>");
                                                                }
        ...
        function buscarAcompanhamentosMedico(){
            $.getJSON('<?= base_url() ?>ambulatorio/guia/buscarAcompanhamentosMedico', {paciente_id: parseInt($("#paciente_acompanhamento_id").val()), ajax: true}, function (j) {
                ...
                for (var c = 0; c < j.length; c++) {
                    ...
                    table_a += "<tr>";
                    table_a +="<td class='tabela_content01'><b><font size='3'>"+j[c].acompanhamento+"</font><b></td>";
                ...
                $('#tabelaAcompanhamento').append(table_a);
