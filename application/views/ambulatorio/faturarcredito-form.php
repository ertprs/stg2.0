...
<body bgcolor="#C0C0C0">
    <div class="content"> <!-- Inicio da DIV content -->
        ...
        <div>
            <form name="form_faturar" id="form_faturar" action="<?= base_url() ?>ambulatorio/exametemp/gravarfaturarcredito/" method="post">
                <fieldset>
                    <table>
                        <tr>
                        ...
                        <tr>
                            <td style="text-align: left">
                                <input type="text" name="valorafaturar" id="valorafaturar" size="7" class="texto01" value="<?= $valor_credito[0]->valor; ?>" readonly />
                    ...
                    <table>
                        ...
                        <tr>
                            <td style="text-align: left">
                                <input type="text" name="valor1" id="valor1" size="2" value="<?= $valor; ?>" onblur="teste1()"/>
                            ...
                            <td style="text-align: left">
                                <input type="text" name="ajuste1" id="ajuste1" size="3" value="<?= $valor; ?>" onblur="teste1()"/>
                            </td>
                            <td style="text-align: left" >
                                <input type="text" name="valorajuste1" id="valorajuste1" size="4" value="<?= $valor; ?>" onblur="teste1()"/>
                            </td>
                            <td style="text-align: left">
                                <input style="width: 60px;" type="number" name="parcela1" id="parcela1" value="1" size="2" min="1" />
                            </td>

                        <input type="hidden" name="totalpagar" id="totalpagar"  class="texto01" onblur="teste1()"/>
                        </tr>
                        ...
                        <tr>
                            <td style="text-align: left">
                                <input type="text" name="valor2" id="valor2" size="2" value="<?= $valor; ?>" onblur="teste1()"/>
                            ...
                            <td style="text-align: left">
                                <input type="text" name="ajuste2" id="ajuste2" size="3" value="<?= $valor; ?>" onblur="teste1()"/>
                            </td>
                            <td style="text-align: left">
                                <input type="text" name="valorajuste2" id="valorajuste2" size="4" value="<?= $valor; ?>" onblur="teste1()"/>
                            </td>
                            <td style="text-align: left">
                        ...
                        <tr>
                            <td style="text-align: left">
                                <input type="text" name="valor3" id="valor3" size="2"  value="<?= $valor; ?>" onblur="teste1()"/>
                            ...
                            <td style="text-align: left">
                                <input type="text" name="ajuste3" id="ajuste3" size="3" value="<?= $valor; ?>" onblur="teste1()"/>  
                            </td>
                            <td style="text-align: left">
                                <input type="text" name="valorajuste3" id="valorajuste3" size="4" value="<?= $valor; ?>" onblur="teste1()"/>
                            </td>
                            <td style="text-align: left">
                        ...
                        <tr>
                            <td style="text-align: left">
                                <input type="text" name="valor4" id="valor4" size="2" value="<?= $valor; ?>" onblur="teste1()"/>
                            ...
                            <td style="text-align: left">
                                <input type="text" name="ajuste4" id="ajuste4" size="3" value="<?= $valor; ?>" onblur="teste1()"/>
                            </td>
                            <td style="text-align: left">
                                <input type="text" name="valorajuste4" id="valorajuste4" size="4" value="<?= $valor; ?>" onblur="teste1()"/>
                            </td>
                            <td style="text-align: left">
                    ...
                    <table>
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="hidden" name="valorcadastrado" id="valorcadastrado" value="<?= $valor_credito[0]->valor; ?>"/>
