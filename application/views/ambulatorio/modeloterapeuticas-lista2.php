...
<div class="content"> <!-- Inicio da DIV content -->
    <div class="bt_link_new">
        <a href="<?php echo base_url() ?>ambulatorio/modeloterapeuticas/carregarmodeloterapeuticas/0">
            Novo Modelo
        </a>
    </div>
    <div id="accordion">
        <h3 class="singular"><a href="#">Modelos Terapeuticas</a></h3>
        <div>
            <table>
                <thead>
                    <tr>
                        <th colspan="5" class="tabela_title">
                            <form method="get" action="<?= base_url() ?>ambulatorio/modeloterapeuticas/pesquisar">
                ...
                <?php
                    ...
                    $consulta = $this->modeloterapeuticas->listar($_GET);
                ...
                <tbody>
                    <?php
                        $lista = $this->modeloterapeuticas->listar($_GET)->orderby('nome')->limit($limit, $pagina)->get()->result();
                     ...
                     ?>
                            <tr>
                                ...
                                <td class="<?php echo $estilo_linha; ?>" width="100px;">
                                    ...
                                    <a href="<?= base_url() ?>ambulatorio/modeloterapeuticas/carregarmodeloterapeuticas/<?= $item->ambulatorio_modelo_terapeuticas_id ?>">
 editar
                                    </a>
                                </td>
                                <td class="<?php echo $estilo_linha; ?>" width="100px;">
                                  
                                    <a href="<?= base_url() ?>ambulatorio/modeloterapeuticas/excluirmodelo/<?= $item->ambulatorio_modelo_terapeuticas_id ?>">
 Excluir
                                    </a>
                                </td>
                        </tr>
