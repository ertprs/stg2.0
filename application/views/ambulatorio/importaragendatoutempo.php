...
<div class="content  "> <!-- Inicio da DIV content -->
    <div id="accordion">
        <h3><a href="#">Carregar Arquivo de Agenda Médica</a></h3>
        <div >
            <form method="POST" action="<?=base_url() . 'ambulatorio/exame/importararquivoagendatoutempo'?>"  enctype="multipart/form-data">
                <table>                
