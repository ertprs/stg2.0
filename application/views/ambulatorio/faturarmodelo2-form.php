...
if (count($forma_cadastrada) > 0) { 
   ...
   $valor_restante = $exame[0]->valor;
    if($exame[0]->valor_pacote_diferenciado == "t"){
        $valor_restante = $exame[0]->valor_diferenciado; 
    }
}
...
if(count($descontomaximo) > 0){
 ...
 $valor_geral = $exame[0]->valor;
    if($exame[0]->valor_pacote_diferenciado == "t"){
        $valor_geral = $exame[0]->valor_diferenciado; 
    }
        ...
        <fieldset>
            ...
            <div>
                <table>
                    ...
                    <tr>
                        <td>
                            <input type="text" name="valor_proc" id="valor_proc" class="input_pequeno" value="<?= number_format($valor_geral, 2, ',', '.'); ?>" readonly />
        ...
        <fieldset>        
            ...
            <table>  
                ...
                <tr>
                    <?
                    if(count($forma_cadastrada) == 0){
                        $exame[0]->tipo_desconto = '';
                    }
                    ?>
                    <td style="padding-left:10px">
                        <select name="desconto_especial" id="desconto_especial" class="input_pequeno" >
...
//                            $('#valor1').attr("readonly", 'true');
                                    ...
                                    if (!selecionado) {
                                        ...
                                        $.getJSON('<?= base_url() ?>autocomplete/buscarsaldopacientetcd', {guia_id: <?= $guia_id ?>, ajax: true}, function (j) { 
