                ...
                <fieldset>
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td style="text-align: left">
                                <input type="text" name="ajuste1" id="ajuste1" size="3" value="<?= $valor; ?>" onblur="multiplica()"/>
                            </td>
                            <td style="text-align: left" >
                                <input type="text" name="valorajuste1" id="valorajuste1" size="4" value="<?= $valor; ?>" onblur="multiplica()"/>
                            </td>
                            <td style="text-align: left">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left">
                                <input type="text" name="ajuste2" id="ajuste2" size="3" value="<?= $valor; ?>" onblur="multiplica()"/>
                            </td>
                            <td style="text-align: left">
                                <input type="text" name="valorajuste2" id="valorajuste2" size="4" value="<?= $valor; ?>" onblur="multiplica()"/>
                            </td>
                            <td style="text-align: left">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left">
                                <input type="text" name="ajuste3" id="ajuste3" size="3" value="<?= $valor; ?>" onblur="multiplica()"/>  
                            </td>
                            <td style="text-align: left">
                                <input type="text" name="valorajuste3" id="valorajuste3" size="4" value="<?= $valor; ?>" onblur="multiplica()"/>
                            </td>
                            <td style="text-align: left">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left">
                                <input type="text" name="ajuste4" id="ajuste4" size="3" value="<?= $valor; ?>" onblur="multiplica()"/>
                            </td>
                            <td style="text-align: left">
                                <input type="text" name="valorajuste4" id="valorajuste4" size="4" value="<?= $valor; ?>" onblur="multiplica()"/>
                            </td>
                            <td style="text-align: left">
