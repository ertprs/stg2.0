...
<div >
    ...
    <div >
        <form name="form_laudo" id="form_laudo" action="<?= base_url() ?>ambulatorio/laudo/editaratestadotarefa/<?= $receituario_id ?>" method="post">
            <div >
                <fieldset>
                    <legend>Dados</legend>
                    <table> 
                        <tr><td width="400px;">Paciente:<?= @$obj[0]->paciente ?></td>
                            <td width="400px;">Tarefa: <?= @$obj[0]->procedimento ?></td>
                            <td>Medico Responsável: <?= @$obj[0]->solicitante ?></td>
                        </tr>
