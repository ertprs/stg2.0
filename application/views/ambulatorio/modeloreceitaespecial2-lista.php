...
<div class="content"> <!-- Inicio da DIV content -->
    <div class="bt_link_new">
        <a href="<?php echo base_url() ?>ambulatorio/modeloreceitaespecial/carregarmodeloreceitaespecial/0">
            Novo Modelo
        </a>
    </div>
    <div id="accordion">
        <h3 class="singular"><a href="#">Modelo Receituário Especial</a></h3>
        <div>
            <table>
                <thead>
                    <tr>
                        <th colspan="5" class="tabela_title">
                            <form method="get" action="<?= base_url() ?>ambulatorio/modeloreceitaespecial/pesquisar">
                ...
                <?php
                    ...
                    $consulta = $this->modeloreceitaespecial->listar($_GET);
                     ...
                     ?>
                            <tr>
                                ...
                                <td class="<?php echo $estilo_linha; ?>" width="100px;">
                                    ...
                                    <a href="<?= base_url() ?>ambulatorio/modeloreceitaespecial/carregarmodeloreceitaespecial/<?= $item->ambulatorio_modelo_receita_especial_id ?>">
 editar
                                    </a>
                            </td>
                            <td class="<?php echo $estilo_linha; ?>" width="100px;">
                                  
                                    <a href="<?= base_url() ?>ambulatorio/modeloreceitaespecial/excluirmodelo/<?= $item->ambulatorio_modelo_receita_especial_id ?>">
 Excluir
                                    </a>
                            </td>
                        </tr>
