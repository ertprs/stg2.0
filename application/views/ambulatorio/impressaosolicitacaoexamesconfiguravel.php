...
if(isset($extra)){
    ...
    if (file_exists("./upload/operadortimbrado/" . 1 . ".png")) {
        $caminho_background = base_url() . "upload/operadortimbrado/" . 1 . ".png";
        $timbrado = true;
    ...
    if ($timbrado) { ?>
        <div class="teste" style="background-size: contain; height: 100%; width: 100%;background-image: url(<?= $caminho_background ?>);">
        <? } ?>
