...
<div class="content"> <!-- Inicio da DIV content -->
    <div class="bt_link_new">
        <a href="<?php echo base_url() ?>ambulatorio/modelomedicamento/carregarmodelomedicamento/0">
            Nova Medicamento
        </a>
    </div>
    <div id="accordion">
        <h3 class="singular"><a href="#">Manter Modelos de Medicamento</a></h3>
        <div>
            <table>
                <thead>
                    <tr>
                ...
                <?php
                    ...
                    $consulta = $this->modelomedicamento->listar($_GET);
                ...
                <tbody>
                    <?php
                        $lista = $this->modelomedicamento->listar($_GET)->orderby('nome')->limit($limit, $pagina)->get()->result();
                     ...
                     ?>
                            <tr>
                                ...
                                <td class="<?php echo $estilo_linha; ?>" width="100px;">
                                    ...
                                    <a href="<?= base_url() ?>ambulatorio/modelomedicamento/carregarmodelomedicamento/<?= $item->medicamento_id ?>">
 editar
                                    </a>
                            </td>
                        </tr>
