...
<div > <!-- Inicio da DIV content -->
    <div class="bt_link_voltar">
        <a href="<?= base_url() ?>ambulatorio/modelorelatorio">
            Voltar
        </a>
    </div>
    <div>
        <h3 class="singular">Cadastrar Modelo Relatorio</h3>
        <div>
            <form name="form_modelosolicitarexames" id="form_modelosolicitarexames" action="<?= base_url() ?>ambulatorio/modelorelatorio/gravar" method="post">

                <div>
                    <textarea id="relatorio" name="relatorio" rows="15" cols="80" style="width: 80%"><?= @$obj->_texto; ?></textarea>
                </div>
                ...
                <fieldset>
                    <div>
                        <label>Nome</label>
                        <input type="hidden" name="ambulatorio_modelo_relatorio_id" class="texto10" value="<?= @$obj->_ambulatorio_modelo_relatorio_id; ?>" />
