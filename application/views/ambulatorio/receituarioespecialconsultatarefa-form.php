...
<div >
    ...
    if (count($receita) == 0) {
        ...
        $receituario_id = $receita[0]->tarefa_receituario_especial_id;
    ...
    <div >
        <form name="form_laudo" id="form_laudo" action="<?= base_url() ?>ambulatorio/laudo/gravarreceituarioespecialtarefa/<?= $tarefa_medico_id ?>" method="post">
            <div >
                <fieldset>
                    <legend>Dados</legend>
                    <table> 
                ...
                <table  >
                    <tr>
                        <td>
                            <div class="bt_link_new" style="width: auto; margin: 5px">
                                <a onclick="javascript:window.open('<?= base_url() ?>ambulatorio/modeloreceitaespecial');" style="width: auto; margin: 5px">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="<?php echo $estilo_linha; ?>" width="60px;"><div class="bt_link">
                                            <a onclick="javascript:window.open('<?= base_url() ?>ambulatorio/laudo/impressaoreceitaespecialtarefa/<?= $item->tarefa_receituario_especial_id; ?>');">Imprimir
                                            </a></div>
                                    </td>
                                    <td class="<?php echo $estilo_linha; ?>" width="60px;"><div class="bt_link">
                                            <a onclick="javascript:window.open('<?= base_url() ?>ambulatorio/laudo/editarcarregarreceituarioespecialtarefa/<?= $tarefa_medico_id ?>/<?= $item->tarefa_receituario_especial_id; ?>');">Editar
                                            </a></div>
                                    </td>
