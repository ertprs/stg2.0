...
<div > <!-- Inicio da DIV content -->
    <div>
        <h3 class="singular">Nova Receita Especial</h3>
        <div>
            <form name="form_modeloreceita" id="form_modeloreceita" action="<?= base_url() ?>ambulatorio/modeloreceita/gravarreceitaatendimento" method="post">

                <div>
                    <table>
                        <tr>
                            <td>
                                <input type="hidden" name="r_especial" id="r_especial" value="on"/>
                            </td>
                        </tr>
                    </table>
                ...
                <fieldset>
                    ...
                    <hr/>
                    <button type="submit" name="btnEnviar" id="btnEnviar">Salvar Receita</button>
