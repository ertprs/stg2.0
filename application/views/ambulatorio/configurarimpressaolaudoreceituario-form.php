...
<div class="content ficha_ceatox"> <!-- Inicio da DIV content -->
    ...
    <!--<div style="width: 100%">-->
    <form name="form_exametemp" id="form_exametemp" action="<?= base_url() ?>ambulatorio/empresa/gravarimpressaolaudoreceituario" method="post">
        <fieldset>
        ...
        <fieldset>
            ...
            <div>
                ...
                <input type="hidden" id="impressao_id" name="impressao_id" value="<?= @$empresa_impressao_laudo_receituario_id ?>"/>
            </div>
            <div style="width: 100%">
                <hr/>
        ...
        <fieldset>
            ...
            <table>
                ...
                <tr class="tabela_content01">
                    <td>
                        Hora de Emissão (Hora onde foi realizado o exame----------->
                    </td>
                    <td style="text-align: left;">
                        _hora_
                    </td>
