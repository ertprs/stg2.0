    ...
    <!--                            <tr>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <div class="col-lg-3">
                        <a class="btn btn-outline btn-warning" onclick="javascript:window.open('<?= base_url() ?>ambulatorio/modeloreceitaespecial');" style="width: 250px; margin: 5px">
                            M. Receituario Especial</a>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="<?php echo $estilo_linha; ?>" width="60px;"><div class="bt_link">
                                                        <a class="btn btn-outline btn-warning" onclick="javascript:window.open('<?= base_url() ?>ambulatorio/laudo/impressaoreceitaespecial/<?= $item->ambulatorio_receituario_especial_id; ?>');"><i class="fa fa-print" aria-hidden="true"></i>
                                                            Imprimir
                                                        </a></div>
                                                </td>
                                                <td class="<?php echo $estilo_linha; ?>" width="60px;"><div class="bt_link">
                                                        <a class="btn btn-outline btn-warning" onclick="javascript:window.open('<?= base_url() ?>ambulatorio/laudo/editarcarregarreceituarioespecial/<?= $ambulatorio_laudo_id ?>/<?= $item->ambulatorio_receituario_especial_id; ?>');">Editar
                                                        </a></div>
                                                </td>
