<div class="content"> <!-- Inicio da DIV content -->
    ...
    <table>
        <thead>
            ...
            <tr>
                <th style='text-align: left; font-family: serif; font-size: 12pt;' colspan="4">PERIODO:
    ...
    <? if (count($relatoriocreditotrans) > 0) { ?>
        <h3>Transferências de Créditos</h3>
        <table>
            <tr>
                <th style='text-align: left;' width="320px;"><font size="-1">Paciente Antigo</th>
                <th style='text-align: left;'width="320px;"><font size="-1">Paciente Novo</th>
                <th style='text-align: right;'width="320px;"><font size="-1">Valor Crédito</th>
                <th style='text-align: right;'width="320px;"><font size="-1">Data da Transferência</th>
            </tr> 
            <?
            foreach ($relatoriocreditotrans as $item) {
                ?>
                <tr>
                    <td ><font size="-1"><?= $item->paciente_antigo ?></td>
                    <td style='text-align: left;'><font size="-1"><?= $item->paciente_novo ?></td>
                    <td style='text-align: right;'><font size="-1"><?= "R$ " . number_format($item->valor, 2, ',', '.') ?></td>
                    <td style='text-align: right;'><font size="-1"><?= date("d/m/Y", strtotime($item->data_cadastro)) ?></td>
                </tr> 
