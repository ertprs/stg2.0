...
<div > <!-- Inicio da DIV content -->
    <div>
        <h3 class="singular">Novo S. Exames</h3>
        <div>
            <form name="form_modeloreceita" id="form_modeloreceita" action="<?= base_url() ?>ambulatorio/modeloreceita/gravarsexamesatendimento" method="post">
                ...
                <fieldset>
                    ...
                    <hr/>
                    <button type="submit" name="btnEnviar" id="btnEnviar">Salvar Exame</button>
