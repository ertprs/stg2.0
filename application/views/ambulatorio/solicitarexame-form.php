                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="<?php echo $estilo_linha; ?>" width="60px;"><div class="bt_link">
                                                <a class="btn btn-outline btn-warning" onclick="javascript:window.open('<?= base_url() ?>ambulatorio/laudo/impressaosolicitarexame/<?= $item->ambulatorio_exame_id; ?>');"><i class="fa fa-print" aria-hidden="true"></i>
Imprimir
                                                </a></div>
                                        </td>
                                        <td class="<?php echo $estilo_linha; ?>" width="60px;"><div class="bt_link">
                                                <a class="btn btn-outline btn-warning" onclick="javascript:window.open('<?= base_url() ?>ambulatorio/laudo/editarexame/<?= $ambulatorio_laudo_id ?>/<?= $item->ambulatorio_exame_id; ?>');">Editar
                                                </a></div>
                                        </td>
