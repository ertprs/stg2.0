        ...
        <div class="col-lg-12">
            <div class="panel panel-default">
                ...
                <div class="table-responsive" id="pesquisar">
                    <form method="post" action="<?= base_url() ?>ambulatorio/modeloreceitaespecial/pesquisar">
                ...
                <div class="panel-body">
                    <a class="btn btn-outline btn-danger" href="<?php echo base_url() ?>ambulatorio/modeloreceitaespecial/carregarmodeloreceitaespecial/0">
                    ...
                    <div class="table-responsive" id="pesquisar">
                        <table width="100%" class="table table-striped table-bordered table-hover " id="dataTables-example">
                            ...
                            $consulta = $this->modeloreceitaespecial->listar($_POST);
                            ...
                            if ($total > 0) {
                                ...
                                <tbody>
                                    <?php
                                    $lista = $this->modeloreceitaespecial->listar($_POST)->orderby('nome')->limit($limit, $pagina)->get()->result();
                                    ...
                                    foreach ($lista as $item) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="tabela_acoes" width="100px;">
                                                ...
                                                <a class="btn btn-outline btn-primary btn-sm" href="<?= base_url() ?>ambulatorio/modeloreceitaespecial/carregarmodeloreceitaespecial/<?= $item->ambulatorio_modelo_receita_especial_id ?>">
                                                    Editar
                                                </a>
                                            </td>
                                        </tr>
