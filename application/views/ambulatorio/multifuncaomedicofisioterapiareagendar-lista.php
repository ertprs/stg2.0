                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th class="tabela_header" colspan="1"><center>Replicar</center></th>
                            ...
                            <td class="<?php echo $estilo_linha; ?>"><input type="checkbox" name="reagendar[<?= $r ?>]" id="reagendar<?= $r ?>" class="texto03 bestupper" /> </td>
                                   <?
                                    ...
                                    <td class="<?php echo $estilo_linha; ?>" width="60px;"><div class="bt_link">
                                            <a onclick="javascript:window.open('<?= base_url() ?>ambulatorio/exametemp/carregarfisioterapiatemp/<?= $item->agenda_exames_id ?>');">Verificar
                                            </a></div>
                                    </td>
                                <? } elseif ($item->bloqueado == 'f') { ?>
                                    <td class="<?php echo $estilo_linha; ?>" width="60px;"><div class="bt_link">
                                            <a onclick="javascript:window.open('<?= base_url() ?>ambulatorio/exametemp/carregarpacientefisioterapiatemp2/<?= $item->paciente_id ?>');">Verificar
                                            </a></div>
                                    </td>
