...
<div class="content"> <!-- Inicio da DIV content -->
    <div id="accordion">
        <h3 class="singular"><a href="#">Faturamento XML Cirurgico Guia</a></h3>
        <div>
            <?
            ...
            $guia = "";
            ?>
            <form method="post" action="<?= base_url() ?>ambulatorio/exame/gerarxmlcirurgico">
                <dl>
                    <dt>
                            ...
                            <table>
                                <tr>
                                    ...
                                    foreach ($convenios as $value) :
                                        ...
                                        $arquivo_pasta = directory_map("./upload/cr_cirurgico/$value->nome/");
                                        ...
                                        <tr>
                                            ...
                                            foreach ($arquivo_pasta as $value) {
                                                ?>
                                                <td width="10px"> <img  width="50px" height="50px" onclick="javascript:window.open('<?= base_url() . "upload/cr_cirurgico/" . $covenionome . "/" . $value ?>', '_blank', 'toolbar=no,Location=no,menubar=no,width=1200,height=600');" src="<?= base_url(); ?>img/archive-zip-icon.png"><br><? echo $value ?></td>
                                                <td>&nbsp;</td>        
                                            <br><?
                                        }
                                    }
