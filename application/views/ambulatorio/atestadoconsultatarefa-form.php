...
<div >
    ...
    if (count($receita) == 0) {
        ...
        $receituario_id = $receita[0]->tarefa_atestado_id;
    ...
    <div >
        <form name="form_laudo" id="form_laudo" action="<?= base_url() ?>ambulatorio/laudo/gravaratestadotarefa/<?= $tarefa_medico_id ?>" method="post">
            <div >
                <fieldset>
                    <legend>Dados</legend>
                    <table> 
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="<?php echo $estilo_linha; ?>" width="60px;"><div class="bt_link">
                                        <a onclick="javascript:window.open('<?= base_url() ?>ambulatorio/laudo/impressaoatestadotarefa/<?= $item->tarefa_atestado_id; ?>');">Imprimir
                                        </a></div>
                                </td>
                                <td class="<?php echo $estilo_linha; ?>" width="60px;"><div class="bt_link">
                                        <a onclick="javascript:window.open('<?= base_url() ?>ambulatorio/laudo/editarcarregaratestadotarefa/<?= $tarefa_medico_id ?>/<?= $item->tarefa_atestado_id; ?>');">Editar
                                        </a></div>
                                </td> 
                            </tr> 
                        </tbody>
