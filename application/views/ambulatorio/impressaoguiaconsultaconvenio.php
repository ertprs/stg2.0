...
<div class="content ficha_ceatox">
    ...
    <table border="1">
        <tbody>
            <tr>
                <td width=200 valign="top" ><font size = -1>1 - Registro ANS</font> <br><b> <?= $exame[0]->registroans; ?></b></td>
...
<p>Dados do Contratado</p>
    <table border="1">
        <tbody>
            <tr>
                <td width=600 valign="top"><font size = -1>9 - Codigo na Operadora</font> <br><b> <?= $exame[0]->codigoidentificador; ?></b></td>
                <td width=200 valign="top"><font size = -1>10 - Nome do Contratado </font><br><b><?= $exame[0]->convenio; ?></b></td>
    ...
    <table border="1">
        <tbody>
            <tr>
                <td width=500 valign="top"><font size = -1>12 - Nome do Profissional Executante </font> <br><b><?= $exame[0]->medicoagenda;?></b></td>
                <td width=90 valign="top"><font size = -1>13 - Conselho Profissional</font><br><b>&nbsp</b></td>
                <td width=200 valign="top" align="center"><font size = -1>14 - Numero no Conselho</font><br><b><?= $exame[0]->conselho;?></b></td>
                <td width=88 valign="top" align="center"><font size = -1>15 - UF</font><br><b><?= substr($exame[0]->cbo_ocupacao_id, 0, 2);?></b></td>
                <td width=100 valign="top" align="center"><font size = -1>16 - Codigo CBO</font><br><b><?= $exame[0]->cbo_ocupacao_id;?></b></td>
            </tr>           
        </tbody>
    </table>
<p>Dados de Atendimento / Procedimento Realizado</p>
    ...
    <table border="1">
        <tbody>
            <tr>
                <td width=225 valign="top" ><font size = -1>18 - Data do Atendimento </font> <br><b><?= substr($exame[0]->data_autorizacao, 8, 2) . "/" . substr($exame[0]->data_autorizacao, 5, 2) . "/" . substr($exame[0]->data_autorizacao, 0, 4); ?></b></td>
                ...
                <td width=225 valign="top" ><font size = -1>21 - Codigo Procedimento</font><br><b><?= $exame[0]->codigo;?></b></td>
                <td width=225 valign="top" ><font size = -1>22 - Valor do Procedimento</font><br><b><?= number_format($exame[0]->valor_total, 2, ',', '.');?></b></td>
            </tr>           
        </tbody>
    </table>
