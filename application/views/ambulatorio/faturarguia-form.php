...
if (count($forma_cadastradaTotal) > 0) {
    $valor_restante = $exame[0]->total - $forma_cadastradaTotal[0]->valor_total_pago;
    $valor_total = $exame[0]->total;
} else {
    $valor_restante = $exame[0]->total;
    $valor_total = $exame[0]->total;
}

if(count($descontomaximo) > 0){
    $total_desconto = 0;
    foreach($descontomaximo as $desconto){
        if($desconto->desconto_procedimento == '' || $desconto->desconto_procedimento == 0.00){
            $desconto_maximo = 100.00;
        }else if($desconto->desconto_procedimento > 100){
            $desconto_maximo = 100.00;
        }else{
            $desconto_maximo = $desconto->desconto_procedimento;
        }

        $total_desconto = $total_desconto + ($desconto->valortotal * ($desconto_maximo / 100));
    }

}else{
    $desconto_maximo = 100.00;
    $total_desconto = $valor_total * ($desconto_maximo / 100);
}
            ...
            <form name="form_faturar" id="form_faturar" action="<?= base_url() ?>ambulatorio/guia/gravarfaturadoguia" method="post">
                <fieldset>
                    <table>
                        ...
                        <tr>
                            <td style="text-align: left">
                                <input type="text" name="valorafaturar" id="valorafaturar" size="7" class="texto01" value="<?= $valor_total; ?>" readonly />
                        ...
                        <tr>
                            <td>
                                <input type="number" name="desconto" id="desconto" size="7" value="<?= $valor; ?>" max="<?=$total_desconto?>" class="texto01"/>
...
<!--                                <input type="checkbox" name="credito" id="credito"/>
                    ...
                    <table>
                        ...
                        <tr>
                            <td style="text-align: left">
                                <input type="text" name="valor1" id="valor1" size="2" value="<?= $valor; ?>" onblur="multiplica2()"/>
                            ...
                            <td style="text-align: left">
                            <input type="text" name="ajuste1" id="ajuste1" size="3" value="<?= $valor; ?>" onblur="multiplica2()"/>
                            </td>
                            <td style="text-align: left" >
                            <input type="text" name="valorajuste1" id="valorajuste1" size="4" value="<?= $valor; ?>" onblur="multiplica2()"/>
                            </td>
                            <td style="text-align: left">
                            <input style="width: 60px;" type="number" name="parcela1" id="parcela1" value="1" size="2" min="1" />
                            </td>
                            
                            <input type="hidden" name="totalpagar" id="totalpagar"  class="texto01" onblur="multiplica2()"/>
                        </tr>
                        ...
                        <tr>
                            <td style="text-align: left">
                                <input type="text" name="valor2" id="valor2" size="2" value="<?= $valor; ?>" onblur="multiplica2()"/>
                            ...
                            <td style="text-align: left">
                            <input type="text" name="ajuste2" id="ajuste2" size="3" value="<?= $valor; ?>" onblur="multiplica2()"/>
                            </td>
                            <td style="text-align: left">
                            <input type="text" name="valorajuste2" id="valorajuste2" size="4" value="<?= $valor; ?>" onblur="multiplica2()"/>
                            </td>
                            <td style="text-align: left">
                        ...
                        <tr>
                            <td style="text-align: left">
                                <input type="text" name="valor3" id="valor3" size="2"  value="<?= $valor; ?>" onblur="multiplica2()"/>
                            ...
                            <td style="text-align: left">
                            <input type="text" name="ajuste3" id="ajuste3" size="3" value="<?= $valor; ?>" onblur="multiplica2()"/>  
                            </td>
                            <td style="text-align: left">
                            <input type="text" name="valorajuste3" id="valorajuste3" size="4" value="<?= $valor; ?>" onblur="multiplica2()"/>
                            </td>
                            <td style="text-align: left">
                        ...
                        <tr>
                            <td style="text-align: left">
                                <input type="text" name="valor4" id="valor4" size="2" value="<?= $valor; ?>" onblur="multiplica2()"/>
                            ...
                            <td style="text-align: left">
                            <input type="text" name="ajuste4" id="ajuste4" size="3" value="<?= $valor; ?>" onblur="multiplica2()"/>
                            </td>
                            <td style="text-align: left">
                            <input type="text" name="valorajuste4" id="valorajuste4" size="4" value="<?= $valor; ?>" onblur="multiplica2()"/>
                            </td>
                            <td style="text-align: left">
                    ...
                    <table>
                     ...
                     <div style="margin-left:500px;margin-top:-540px;position: absolute;">
                         <dt id="legenda_obs_cred" hidden>
                       <label   >Observa&ccedil;&atilde;o(Caso for usar Crédito)</label>
                    </dt>
                    <dd>
                        <div id="">
                            <textarea style="  color:black; " type="text" id="observacaocred" name="observacaocred" class="texto"  value="" cols="50" rows="4"  disabled hidden><?
                            $contobs = count($obs);
                            foreach($obs  as $item){
                                echo $item->observacaocredito;
                                if ($contobs > 1) {
                                    echo ",";
                                }
                                $contobs--; 
                                                ...
                                                if(this.value == 1000){
                                                    ...
                                                    $.getJSON('<?= base_url() ?>autocomplete/buscarsaldopaciente', {guia_id: <?= $guia_id; ?>, ajax: true}, function (j) {
                                                        if(!selecionado){
                                                         ...
                                                         if (j.saldo !="") {  
//                                                                alert('tsttt');
                                                              $('#observacaocred').show();//COLOCA A OBSERVAÇÃO
                                                               $('#legenda_obs_cred').show();//COLOCA A OBSERVAÇÃO
                                                    ...
                                                    multiplica(); 
                                                    $('#observacaocred').hide(); //TIRA A OBSERVAÇÃO
                                                $('#legenda_obs_cred').hide();//COLOCA A OBSERVAÇÃO
                                                }
