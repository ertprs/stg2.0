<div class="content"> <!-- Inicio da DIV content -->
    <div id="accordion">
        <h3><a href="#">Gerar Relatório Extrato Consolidado dos Médico</a></h3>
        <div>
            <form name="form_paciente" id="form_paciente"  method="post" action="<?= base_url() ?>ambulatorio/guia/gerarelatorioextratoconsolidado">
                <dl>
                    ...
                    <dd>
                        <select name="convenio[]" id="convenio" class="size2 chosen-select" data-placeholder="Selecione os convênios (Todos ou vázio trará todos)..." multiple>
                            <option value='0' >TODOS</option>
                    ...
                    <dd>
                        <select name="grupo[]" id="grupo" class="size2 chosen-select" data-placeholder="Selecione as especialidades (Todos ou vázio trará todos)..." multiple>
                            <option value='0' >TODOS</option>
                    ...
                    <dd>
                        <?php $empresa_id = $this->session->userdata('empresa_id');?>
