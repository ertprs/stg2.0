<div >
    ...
    <div >
        <form name="form_laudo" id="form_laudo" action="<?= base_url() ?>ambulatorio/laudo/editarreceituariotarefa/<?= $receituario_id ?>" method="post">
            <div >
                <fieldset>
                    <legend>Dados</legend>
                    <table> 
                    ...
                    <div> 
                        <fieldset>
                            ...
                            <div>
                                ...
                                <input type="hidden" id="ambulatorio_laudo_id" name="tarefa_medico_id" value="<?= $tarefa_medico_id ?>"/>
