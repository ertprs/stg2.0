...
<div > <!-- Inicio da DIV content -->
    <div>
        <h3 class="singular">Nova Terapeutica</h3>
        <div>
            <form name="form_modeloreceita" id="form_modeloreceita" action="<?= base_url() ?>ambulatorio/modeloreceita/gravarterapeuticaatendimento" method="post">
                ...
                <fieldset>
                    ...
                    <hr/>
                    <button type="submit" name="btnEnviar" id="btnEnviar">Salvar Terapeuticas</button>
