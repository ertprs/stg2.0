...
<div class="content"> <!-- Inicio da DIV content -->
    <div class="bt_link_new">
        <a class="btn btn-outline-default btn-sm" href="<?php echo base_url() ?>ambulatorio/tipoconsulta/carregartipoconsulta/0">
            Novo Tipo Agenda
        </a>
    </div>
    <div id="accordion">
                         ...
                         ?>
                                <tr>
                                    ...
                                    <td class="<?php echo $estilo_linha; ?>" width="70px;">
                                        <a class="btn btn-outline-warning btn-sm" href="<?= base_url() ?>ambulatorio/tipoconsulta/carregartipoconsulta/<?= $item->ambulatorio_tipo_consulta_id ?>">Editar</a>
                                </td>
                                <?php if($perfil_id != 18 && $perfil_id != 20){ ?>
                                    <td class="<?php echo $estilo_linha; ?>" width="70px;">
                                        <a class="btn btn-outline-danger btn-sm" onclick="javascript: return confirm('Deseja realmente exlcuir esse Tipo?');" href="<?= base_url() ?>ambulatorio/tipoconsulta/excluir/<?= $item->ambulatorio_tipo_consulta_id ?>">Excluir</a>
                                    </td>
                                <?php }?>
                            </tr>
                            ...
                            <tfoot>
                                <tr class="text-center pag">
                                    <th class="tabela_footer pagination-container" colspan="4">
