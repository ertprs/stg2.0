<!DOCTYPE html>
<head>
<title>Modelo Terapeuticas</title>
</head>
<div > <!-- Inicio da DIV content -->
    <div class="bt_link_voltar">
        <a href="<?= base_url() ?>ambulatorio/modeloterapeuticas">
            Voltar
        </a>
    </div>
    <div>
        <h3 class="singular">Cadastrar Modelo Terapeutica</h3>
        <div>
            <form name="form_modelosolicitarexames" id="form_modelosolicitarexames" action="<?= base_url() ?>ambulatorio/modeloterapeuticas/gravar" method="post">

                <div>
                    <textarea id="terapeuticas" name="terapeuticas" rows="15" cols="80" style="width: 80%"><?= @$obj->_texto; ?></textarea>
                </div>
                ...
                <fieldset>
                    <div>
                        <label>Nome</label>
                        <input type="hidden" name="ambulatorio_modelo_terapeuticas_id" class="texto10" value="<?= @$obj->_ambulatorio_modelo_terapeuticas_id; ?>" />
