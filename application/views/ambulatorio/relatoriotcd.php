<div class="content"> <!-- Inicio da DIV content -->
    ...
    <div id="accordion">
        <h3><a href="#">Gerar Relatório TCD</a></h3>
        <div>
            <form method="post" action="<?= base_url() ?>ambulatorio/guia/gerarelatoriotcd">
                <dl>   
                    <dt>
                        <label>Paciente</label>
                    </dt>
                    <dd>
                        <input type="text" name="paciente" class="texto10" id="paciente" />
                    </dd> 
