<div class="content"> <!-- Inicio da DIV content --> 
    <div id="accordion">
        ...
        <div>
            <form name="form_exameespera" id="form_exameespera" action="<?= base_url() ?>cadastros/contaspagar/excluir/<?= $financeiro_contaspagar_id; ?>" method="post">
                ...
                <dl class="dl_desconto_lista">
                    ...
                    <dd>
                        <input type="hidden" name="financeiro_contaspagar_id" value="<?=  $financeiro_contaspagar_id; ?>" /> 
