<div class="content"> <!-- Inicio da DIV content --> 
    <div id="accordion">
        ...
        <div>
            <form name="form_exameespera" id="form_exameespera" action="<?= base_url() ?>cadastros/caixa/excluirentrada/<?= $entradas_id; ?>" method="post">
                ...
                <dl class="dl_desconto_lista">
                    ...
                    <dd>
                        <input type="hidden" name="entradas_id" value="<?=  $entradas_id; ?>" /> 
