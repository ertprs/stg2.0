<div class="content"> <!-- Inicio da DIV content --> 
    <div id="accordion">
        <h3 class="singular"><a href="#">Exclusão financeiro</a></h3>
        <div>
            <form name="form_exameespera" id="form_exameespera" action="<?= base_url() ?>cadastros/contasreceber/excluir/<?= $financeiro_contasreceber_id; ?>" method="post">
                ...
                <dl class="dl_desconto_lista">
                    ...
                    <dd>
                        <input type="hidden" name="financeiro_contasreceber_id" value="<?=  $financeiro_contasreceber_id; ?>" /> 
