<link href="<?= base_url() ?>css/paciente-ficha.css" rel="stylesheet"/>
<div id="page-wrapper"> <!-- Inicio da DIV content -->
    <form name="form_paciente" id="form_paciente" action="<?= base_url() ?>cadastros/pacientes/gravar" method="post">
        ...
        <div class="container">
                ...
                <div class="alert alert-success pagname">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="rg"  id="txtDocumento" class="form-control texto04 inptresize" maxlength="20" value="<?= @$obj->_documento; ?>" />
                            </div>
                        </div>
                        <div class="col-lg-3">
            ...
            <div class="panel panel-default obsalert">
                <div class="alert alert-info">
                    Observações e Cirurgias Anteriores
                </div>
                <div class="panel-body obsdata">
                    <div class="row">
    ...
    <script language="JavaScript">
      ...
      Webcam.attach ('#my_camera');
        ...
        function imagem_paciente() {
        //envia a foto para o servidor
        Webcam.upload( data_uri, 'image-paciente', function(code, text) {
			// Upload complete!
