<div class="content"> <!-- Inicio da DIV content -->
    ...
    <table>
        <thead>
            ...
            ?>
            <tr>
                <th style='text-align: left; font-family: serif; font-size: 12pt;' colspan="4">SALDO/ENTRADA PRODUTOS</th>
            </tr>
            <tr>
    ...
    <? if ($contador > 0) {
            ...
            <tbody>
                ...
                foreach ($relatorio as $item) :
                    ...
                    if ($i == 1 || $item->armazem == $armazem) {
                        $qtde++;
                        $qtdetotal++;
                        $qtdintens = $qtdintens + $item->quantidade;
                        $qtdintenstotal = $qtdintenstotal + $item->quantidade;
                        $valor = $valor + $item->valor_compra;
                        $valortotal = $valortotal + $item->valor_compra;
                        ...
                        ?>
                        <tr>
                            <td width="140px;" align="Right" colspan="9"><b>Qtda Produto:&nbsp; <?= $qtdintens; ?></b></td>
                            <td width="140px;" align="Right" colspan="9"><b>Valor total:&nbsp; <?= $valor; ?></b></td>
                        </tr>
                        <tr>
        ...
        <table>
            <tbody>
                ...
                <tr>
                    <td width="140px;" ><b>Nr. Itens: &nbsp;<?= $qtdetotal; ?></b></td>
                </tr>
                <tr>
                    <td width="140px;"  ><b>Qtda Produto: </b></td>
                    <td><b><?= $qtdintenstotal; ?></b></td>
                </tr>
                <tr>
                    <td width="140px;" ><b>Valor total: </b></td>
