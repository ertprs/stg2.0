...
<body bgcolor="#C0C0C0">
    <div class="content"> <!-- Inicio da DIV content -->
        ...
        <div>
            <form name="form_faturar" id="form_faturar" action="<?= base_url() ?>centrocirurgico/centrocirurgico/gravarfaturadoequipe" method="post">
                <fieldset>
                    <table>
                        <tr>
                        ...
                        <tr>
                            <td>
                                <input type="text" name="desconto" id="desconto" size="7" value="<?= $valor; ?>" class="texto01" onblur="history.go(0)"/>
