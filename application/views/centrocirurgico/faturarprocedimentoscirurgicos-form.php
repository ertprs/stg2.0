...
<body bgcolor="#C0C0C0">
    <div class="content"> <!-- Inicio da DIV content -->
        ...
        <div>
            <form name="form_faturar" id="form_faturar" action="<?= base_url() ?>centrocirurgico/centrocirurgico/gravarfaturadoprocedimentos" method="post">
                <fieldset>
                    <table>
                        <tr>
                        ...
                        <tr>
                            <td style="text-align: left">
                                ...
                                <input type="hidden" name="solicitacao_id" id="solicitacao_id" class="texto01" value="<?= $solicitacao_id; ?>"/>
                                <input type="hidden" name="financeiro_grupo_id" id="financeiro_grupo_id" class="texto01" value="<?= $financeiro_grupo_id; ?>"/>
                                <input type="hidden" name="data" id="data" class="texto01" value="<?= @$_GET['data']; ?>"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td>
                                <input type="text" name="desconto" id="desconto" size="7" value="<?= $valor; ?>" class="texto01" onblur="multiplica()"/>
