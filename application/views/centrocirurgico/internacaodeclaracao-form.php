...
<body bgcolor="#C0C0C0">
    ...
    <div class="content"> <!-- Inicio da DIV content -->
        ...
        <div>
            <form name="form1" id="form1" action="<?= base_url() ?>centrocirurgico/centrocirurgico/impressaodeclaracaointernacao/<?= $internacao[0]->internacao_id; ?>" method="post">
                <fieldset>
                    <dl class="dl_desconto_lista">
                        ...
                        <dd>
                            <textarea id="declaracao" name="declaracao" cols="90" rows="30" ><?= $internacao[0]->declaracao ?></textarea>
                        </dd>
                    </dl>    
