...
<div class="content"> <!-- Inicio da DIV content -->
    <div class="bt_link_new">
        <a href="<?php echo base_url() ?>centrocirurgico/centrocirurgico/carregarhospital/0">
            Novo Hospital
        </a>
    </div>
    <div id="accordion">
        <h3 class="singular"><a href="#">Manter Hospital</a></h3>
        <div>
            <table>
                <thead>
                    <tr>
                ...
                <tbody>
                    <?php
                        $lista = $this->centrocirurgico_m->listarhospitais($_GET)->limit($limit, $pagina)->orderby("nome")->get()->result();
