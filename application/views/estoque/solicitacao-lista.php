...
<div class="col-lg-12">
    <!-- <div class="content"> Inicio da DIV content -->
        <div class="bt_link_new">
            <a class="btn btn-outline-danger btn-round btn-sm" href="<?php echo base_url() ?>estoque/solicitacao/criarsolicitacao/0">
                Novo Solicitacao
            </a>
        </div>
        <?
                        ...
                        <tr>
                            <!-- <th colspan="10" class="tabela_title"> -->
                                <form method="get" action="<?= base_url() ?>estoque/solicitacao/pesquisar">
                                    <div class="container">   
                                        <div class="inpt">
                                        <input type="text" name="nome" class="texto12 bestupper form-control" value="<?php echo @$_GET['nome']; ?>" />
                                        </div>
                                        
                                        <div class="btPesq">
                                            <button type="submit" id="enviar"  class="btn-outline-default btn-round btn-sm">Pesquisar</button>
                                        </div>
                                    </div>
