                ...
                <form method="get" action="<?= base_url() ?>estoque/inventario/pesquisar">
                    ...
                    <tr>
                        <th class="tabela_title">
                            <input type="text" name="produto" class="form-control" value="<?php echo @$_GET['produto']; ?>" colspan="4"/>
                        </th>
                        <th class="tabela_title">
                            <input type="text" name="fornecedor" class="form-control" value="<?php echo @$_GET['fornecedor']; ?>" />
                        </th>
                        <th class="tabela_title">
                            <input type="text" name="nota" class="form-control" value="<?php echo @$_GET['nota']; ?>" colspan="4"/>
                        </th>
                        <th class="tabela_title">
