...
class Google_Service_Calendar_Acl_Resource extends Google_Service_Resource
{
   ...
   */
  public function delete($calendarId, $ruleId, $optParams = array(), $token_array)
  {
    $params = array('calendarId' => $calendarId, 'ruleId' => $ruleId);
    $params = array_merge($params, $optParams);
    return $this->call('delete', array($params), NULL, $token_array);
  }
...
class Google_Service_Calendar_Events_Resource extends Google_Service_Resource
{
   ...
   */
  public function delete($calendarId, $eventId, $optParams = array(), $token_array)
  {
   ...
   * @return Google_Service_Calendar_Events
   */
  public function listEvents($calendarId, $optParams = array(), $token_array = null)
  {
    $params = array('calendarId' => $calendarId);
    $params = array_merge($params, $optParams);
    return $this->call('list', array($params), "Google_Service_Calendar_Events", $token_array);
  }
